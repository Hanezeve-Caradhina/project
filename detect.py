...
def detect(img_source,opt,save_img=False):
    results = []
    ...
    print("detect.py 56 dataset: ",dataset)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    results.append(result(obj_id,cls,xyxy))
                    obj_id+=1
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        if opt.update:  # update all models (to fix SourceChangeWarning)
            ...
            obj_results=detect('left_1.jpg',opt)
            print(obj_results)